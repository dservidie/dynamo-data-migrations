...
export async function down(profile = 'default', downShift = 1, env = '') {
...
async function executeDown(ddb: AWS.DynamoDB, file: { fileName: string; appliedAt: string }, env: string) {
    try {
